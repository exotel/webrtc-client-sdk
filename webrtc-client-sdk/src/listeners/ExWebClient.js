...
export class ExotelWebClient {
    ...
    //function for input and output devices, webrtcSIPPhone.func
    	changeInputDevice(deviceId, onSuccess, onError, resetInputDeviceOnCallEnd) {
		console.log(`in changeInputDevice() of ExWebClient.js`);
		webrtcSIPPhone.changeInputDevice(deviceId, onSuccess, onError, resetInputDeviceOnCallEnd);
	}

	changeOutputDevice(deviceId, onSuccess, onError, resetOutputDeviceOnCallEnd) {
        console.log(`in changeOutputDevice() of ExWebClient.js`);
		webrtcSIPPhone.changeOutputDevice(deviceId, onSuccess, onError, resetOutputDeviceOnCallEnd);
	}
}
