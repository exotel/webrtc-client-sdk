...
export function webrtcSIPPhoneService() {

	this.init = function (engine, result, webRTCStatusCallbackHandler, webrtcPhoneDelegate,uiCallbackHandler) {
	...
	this.clearCheckWebRTCTimers =  function() {
	...
	this.getWebrtcLogger = function () {
		return logger;
	}

	this.setWebrtcLogger = function (clientLogger) {
		logger = clientLogger;
	}
