...
**Currently pinned: `@exotel-npm-dev/webrtc-client-sdk` `^3.0.16` (core-sdk 3.0.14).**
...
call — plus `sipHeaders`, every header on the INVITE. Shipped in client-sdk **v3.0.15** (core-sdk v3.0.13); this sample app pins v3.0.16.
